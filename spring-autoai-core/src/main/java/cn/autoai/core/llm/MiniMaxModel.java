...
/**
 * MiniMax adapter, supports streaming and non-streaming output.
 */
public class MiniMaxModel implements AutoAiModel {
    ...
    public MiniMaxModel(String name, String apiKey, ObjectMapper objectMapper) {
        this(name, DEFAULT_BASE_URL, apiKey, objectMapper,
            HttpClient.newBuilder().connectTimeout(Duration.ofSeconds(30)).build());
    }

    public MiniMaxModel(String name, String baseUrl, String apiKey, ObjectMapper objectMapper, HttpClient httpClient) {
        this.name = name;
